(function () {
  try {
    ...
    function openUpdate(version, changelog) {
      openModal(
        `¡New version! <span style="opacity: 0.5">${version}</span>`,
        `
    ...
    function settingsManager() {
      ...
      setInterval(() => {
        ...
        Object.keys(settings).forEach((setting) => {
          ...
          document
            .querySelector("html")
            .setAttribute("data-betterwhatsapp_settings-" + setting, value);
        });
      }, 1000);
    }
    ...
    setInterval(() => {
      if (document.querySelector('[data-icon="wa-wordmark-refreshed"]')) {
        document.querySelector("html").dataset.betterwhatsapp_isWhatsappRefreshed =
          true;
      }
    }, 100);
    ...
    setInterval(() => {
      if (
        document.querySelector("html").dataset
          .betterwhatsapp_settingsProfilepictureonbackground !== "true"
      )
        return;
      function putPfpOnBg() {
                ...
                <div id="betterwhatsappmessage" style="display:flex;flex-direction: column;padding:0px 24px;">
                    <div style="display: flex;">
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <p style="font-size: 12px; margin-top: 8px;">Created by <b style="font-weight: bold;">@pico190_</b></p>
                        </div>
